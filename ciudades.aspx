<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ciudades.aspx.vb" Inherits="ciudades" %>
                       ...
                       <div class="content-wrapper">
                           <div class="row">
                               <div class="col-lg-6 grid-margin stretch-card">
                                   <div class="card">
                                       <div class="card-body">
                                           <h4 class="card-title">Indicador por ciudad</h4>
                                ...
                                <div class="col-lg-6 grid-margin stretch-card">
                                   <div class="card">
                                       <div class="card-body">
                                           <h4 class="card-title">Indicador por ciudad</h4>
                                             <p class="card-description">
                                               <asp:DropDownList ID="ddlEstadoAcum" runat="server" AutoPostBack ="true" ></asp:DropDownList>
                                               </p>
                                           <p class="card-description">
                                               <asp:DropDownList ID="ddlCiudadAcum" runat="server" AutoPostBack ="true" ></asp:DropDownList>
                                               </p>
                                           <p class="card-description">
                                           ...
                                           <div class="table-responsive">
                                               <table class="table">
                                                   <thead>
                                                       <tr>
                                                           <asp:Panel ID="pnlcolumnasCiudad2" runat="server"></asp:Panel>
                                                   
                                                       </tr>
                                                   </thead>
                                                   <tbody>
                                                        <asp:Panel ID="pnlFilasCiudad2" runat="server"></asp:Panel>
