...
<body>
                       ...
                       <div class="content-wrapper" id="imprimir">
                           ...
                           <div class="row">
                               <div class="col-lg-6 grid-margin stretch-card">
                                   <div class="card">
                                       <div class="card-body">
                                           <h4 class="card-title">Indicador por empresa</h4>
                               ...
                               <div class="row" >
                                   ...
                                   <div class="col-lg-12 grid-margin stretch-card">
                                       <div class="card">
                                           <div class="card-body">
                                               <h4 class="card-title">Indicador por Familia e Hijos</h4>
                             ...
                             <div class="col-lg-6 grid-margin stretch-card">
                                  ...
                                  <a href="javascript:htmlTableToExcel('xlsx')" class="btn btn-primary mr-2" >Exportar a Excel</a>
    ...
    <script type="text/javascript">
        function htmlTableToExcel(type) {
            ...
            XLSX.writeFile(excelFile, 'ExportedFile:FamiliaHijos.' + type);
        }
    </script>
    <script>
