<%@ Page Language="VB" AutoEventWireup="false" CodeFile="vendedores.aspx.vb" Inherits="vendedores" %>
                       ...
                       <div class="content-wrapper">
                           <div class="row">
                               <div class="col-lg-6 grid-margin stretch-card">
                                   <div class="card">
                                       <div class="card-body">
                                           <h4 class="card-title">Indicador por vendedor</h4>
                                           <p class="card-description">
                                               <asp:DropDownList ID="ddlVendedor" runat="server" AutoPostBack ="true" ></asp:DropDownList>
                                               </p>
                                           <p class="card-description">
                                              Toneladas por mes
                                           </p>
                                ...
                                <div class="col-lg-6 grid-margin stretch-card">
                                   <div class="card">
                                       <div class="card-body">
                                           <h4 class="card-title">Indicador por vendedor</h4>
                                           <p class="card-description">
                                               <asp:DropDownList ID="ddlVendedorAcum" runat="server" AutoPostBack ="true" ></asp:DropDownList>
                                               </p>
                                           <p class="card-description">
                                           ...
                                           <div class="table-responsive">
                                               <table class="table">
                                                   <thead>
                                                       <tr>
                                                           <asp:Panel ID="pnlcolumnasvendedor2" runat="server"></asp:Panel>
                                                   
                                                       </tr>
                                                   </thead>
                                                   <tbody>
                                                        <asp:Panel ID="pnlFilasVendedor2" runat="server"></asp:Panel>
